...
import { calcualtorIcons, routes } from '../../components/Navbar';
  ...
  const calculators: Calculator[] = [
    {
      ...
      icon: calcualtorIcons[routes.MULTIFAMILY_DEVELOPMENT],
    ...
    },
    {
      ...
      icon: calcualtorIcons[routes.INDUSTRIAL_DEVELOPMENT],
    ...
    },
    {
      ...
      icon: calcualtorIcons[routes.RESIDENTIAL_DEVELOPMENT],
    ...
    },
    {
      ...
      icon: calcualtorIcons[routes.CONSTRUCTION_BUDGET],
    ...
    },
    {
      ...
      icon: calcualtorIcons[routes.MULTIFAMILY_ANALYSIS],
    ...
    },
    {
      ...
      icon: calcualtorIcons[routes.INDUSTRIAL_PRICE_PER_SQFT],
    ...
    },
    {
      ...
      icon: calcualtorIcons[routes.MULTI_FAMILY_PRICE_PER_DOOR],
    ...
    },
    {
      ...
      icon: calcualtorIcons[routes.IRR_CALCULATOR],
    ...
    },
    {
      ...
      icon: calcualtorIcons[routes.SITE_PLAN_BUILDER],
