...
import industrialProformaCalculations from '../utils/industrialProformaCalculations';


const IndustrialProformaCalculator = ({ isMobile, page }: { isMobile: boolean; page: EPageNames; }) => {
  ...
  const {
    ...
    loanAmount,
    breakevenLoanAmount
  } = industrialProformaCalculations(params)
    ...
    <>
      ...
      <div className="table-container">
        ...
        <DynamicRow
          ...
          cellValues={["Leasable SQFT (#)", units]}
          isMobile={isMobile}
          numberOfCells={2}
          inputCellIndex={1}
        />
        ...
        <DynamicRow
          ...
          cellValues={["Lease rate ($/SQFT/year)", rentPerUnit]}
          isMobile={isMobile}
          numberOfCells={2}
          inputCellIndex={1}
        />
        ...
        <DynamicRow
          ...
          cellValues={["Total Building Repair ($)", repairPerUnit]}
          isMobile={isMobile}
          numberOfCells={2}
          inputCellIndex={1}
        />
        ...
        <DynamicRow
          cellValues={['Price per SQFT', roundAndLocalString(pricePerDoor)]}
          isMobile={isMobile}
          numberOfCells={2}
          inputCellIndex={1}
        />
...
export default IndustrialProformaCalculator;
