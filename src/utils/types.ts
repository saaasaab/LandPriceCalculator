...
export enum EPageNames {
    ...
    HOTEL_PRICE_PER_KEY = "HOTEL_PRICE_PER_KEY",
...
export enum EPageTitles {
    MULTIFAMILY_DEVELOPMENT = "Multifamily Development Calculator",
    ...
    RESIDENTIAL_DEVELOPMENT = "Residential Development Feasibility",
    MULTI_FAMILY_PRICE_PER_DOOR = "Multifamily Price Per Door Calculator",
    HOTEL_PRICE_PER_KEY = "Hotel Price Per Key Calculator",
    INDUSTRIAL_PRICE_PER_SQFT = "Industrial Price Per Square Foot Calculator",
    MULTIFAMILY_ANALYSIS = "Multifamily Proforma",
    INDUSTRIAL_PROFORMA = "Industrial and Commercial Proforma",
    IRR_CALCULATOR = "Seller IRR Estimator",
    HARD_MONEY_COST_ESTIMATOR = "Hard Money Loan Estimator",
    WATERFALL_GENERATOR = "Waterfall Distribution Calculator",
    CONSTRUCTION_BUDGET = "Construction Budget Generator",
    SITE_PLAN_BUILDER = "Site Plan Builder",
    CUT_FILL_CALCULATOR = "Cut and Fill Calculator",
    TOPOLOGY_ANALYSIS = "Terrain and Slope Analysis",
