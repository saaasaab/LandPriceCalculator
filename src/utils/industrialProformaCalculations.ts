...
type TIndustrialProformaCalculationsInputs = {
...
type TIndustrialProformaCalculationsOutputs = {
    rentalIncome: number;
    allInCosts: number;
    pricePerDoor: number;
...
const industrialProformaCalculations = (inputs: TIndustrialProformaCalculationsInputs): TIndustrialProformaCalculationsOutputs => {
    const {
...
export default industrialProformaCalculations;
